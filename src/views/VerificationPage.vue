    ...
    <ContentWrapper :sectionClass="['py-[20vh]', 'md:py-[20vh]']">
        <div class="max-w-[600px] mx-auto shadow-lg shadow-slate-200">
            ...
            <div class="py-8 px-12 bg-slate-50">
                ...
                <div class="py-4">
                    <button @click="authStore.verifyOTP" class="block w-full py-3 rounded border bg-rose-600 hover:bg-rose-700 text-white font-bold transition-all">Verify</button>
                </div>
            </div>
        </div>
    </ContentWrapper>
